...
class TestIt(unittest.TestCase):
    ...
    def test_contains_pangram_true(self):
        text = ("About 1,300,000,000 results (0.47 seconds) Search ResultsThe "
    ...
    def test_find_pangram(self):
        text = (" - Wikipedia The quick brown fox jumps over the lazy dog is "
    ...
    def test_find_pangram_two(self):
        text = ("The best known pangram: The quick brown fox jumps over the "
